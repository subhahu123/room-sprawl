...
{// This is our "level editor", where all the rooms are created (using the addRoom method rooms.js)
	...
	addRoom(1,0, "The Island", "You will find yourself in a small island. ",null,"ujjwal");
	...
	addRoom(3,0, "Shiny Cup", "At the end of the worm pipe there is a small storage area half a meter wide. It looks like a place to hide something. A hole on top makes way for sunlight to light a jar-sized cup.","ujjwal", "Shiny Cup");
	...
	addRoom(3,7, "Nokomis Spider Room", "You enter a room where the walls and the floor and the ceiling are covered in cob webs and spiders. In the middle of the room, a brood mother hovers over her clutch of spidereggs", null, "SpiderholdingBag");
    ...
    addRoom(5,7, "Desolate Break Room", "You are surrounded by a strange arrangement of chairs, tables and clutter. You see that age has really left the room in a state. Insects and small rodents seem to be thriving here.")
    ...
    addRoom(6,7, "Creepy Conservatory", "You enter a conservatory full of perishing plants except for a white lily planted in a pot in the corner. As you glance around the barren room, you admire the flower's strange life and pureness.", "Ray of Hope", "White Lily");
